...
exports.acePostWriteDomLineHTML = function(hook_name, args, cb) {
    ...
    //console.log("acePostWriteDomLineHTML args " + JSON.stringify(args) + " text " + JSON.stringify(args.node.innerHTML));
    ...
    if (txt !== '') { //&& JSON.stringify(args.node) == "{}") {
        ...
        //console.log(shBrush + "/" + hl.language + " SYNTAX: " + hl.value);
        // TODO / OPTION with newer versions of highlight.js, curly brace detection might need to detected here.
